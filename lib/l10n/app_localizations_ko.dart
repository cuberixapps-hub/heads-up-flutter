...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get noInternetDescription =>
      '인터넷 연결을 확인하고 다시 시도해 주세요. 이 앱을 사용하려면 활성 인터넷 연결이 필요합니다.';

  @override
  String get tryAgainButton => '다시 시도';

  @override
  String get checkingConnection => '확인 중...';

  @override
  String get tipsToReconnect => '재연결 팁:';

  @override
  String get tipEnableWifi => 'WiFi가 활성화되어 있는지 확인';

  @override
  String get tipTryMobileData => '모바일 데이터로 전환해 보기';

  @override
  String get tipMoveCloser => '라우터에 더 가까이 이동';

  @override
  String get tipRestartDevice => '기기 재시작';
