...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get noInternetDescription =>
      'Пожалуйста, проверьте подключение к интернету и повторите попытку. Для работы этого приложения требуется активное интернет-соединение.';

  @override
  String get tryAgainButton => 'Повторить';

  @override
  String get checkingConnection => 'Проверка...';

  @override
  String get tipsToReconnect => 'Советы по подключению:';

  @override
  String get tipEnableWifi => 'Проверьте, включен ли WiFi';

  @override
  String get tipTryMobileData => 'Попробуйте переключиться на мобильные данные';

  @override
  String get tipMoveCloser => 'Подойдите ближе к роутеру';

  @override
  String get tipRestartDevice => 'Перезагрузите устройство';
