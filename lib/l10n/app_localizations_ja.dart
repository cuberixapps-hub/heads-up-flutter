...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get noInternetDescription =>
      'インターネット接続を確認して、もう一度お試しください。このアプリを使用するには、アクティブなインターネット接続が必要です。';
  ...
  @override
  String get tipsToReconnect => '再接続のヒント：';

  @override
  String get tipEnableWifi => 'WiFiが有効になっているか確認';

  @override
  String get tipTryMobileData => 'モバイルデータに切り替えてみる';

  @override
  String get tipMoveCloser => 'ルーターに近づく';

  @override
  String get tipRestartDevice => 'デバイスを再起動する';
