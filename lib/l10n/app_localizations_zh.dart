...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get noInternetDescription => '请检查您的网络连接并重试。此应用需要有效的网络连接才能运行。';
  ...
  @override
  String get tipsToReconnect => '重新连接提示：';

  @override
  String get tipEnableWifi => '检查WiFi是否已启用';

  @override
  String get tipTryMobileData => '尝试切换到移动数据';

  @override
  String get tipMoveCloser => '靠近路由器';

  @override
  String get tipRestartDevice => '重启您的设备';
